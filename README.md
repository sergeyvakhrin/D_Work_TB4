...
Пользователь может:
1. Просматривать свой профиль отправив GET-запрос на /users/{id}/
    - Ответ:    
    {
    "users_list": [],
    "phone": "+71111111112",
...
2. Ввести один раз инвайт-код другого пользователя отправив PATCH-запрос на /users/update/{id}/
        {
...
3. редактировать свой профиль отправив PUT-запрос на /users/update/{id}/
        {
        "phone": "+78888888888",
        "email": "admin@sky.pro",
        "first_name": "Admin",
...
5. Что бы номер телефона изменился, необходимо отправить PATCH-запрос на /users/update/sms/{id}/ с новым номером
...
5. удалить свой профиль отправив DELETE-запрос на /users/delete/{id}/
