...
1. Для запуска приложения необходимо клонировать репозиторий.
   Для этого выполните в консоли команду: git clone git@github.com:https://github.com/sergeyvakhrin/D_Work_TB4.git
...
7. Инструкции по API будут доступны по адресу http://127.0.0.1:8000/redoc/
